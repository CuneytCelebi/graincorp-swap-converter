...
- from_site_name: format as "SITECODE SITENAME GC" using the actual code and site name from the FROM table e.g. "5168 MIRROOL GC" — use the actual numeric code from the document, NOT "2203"
- to_site_name: format as "SITECODE SITENAME GC" using the actual code and site name from the TO table e.g. "4207 RED BEND GC" — use the actual numeric code from the document, NOT "2203"
